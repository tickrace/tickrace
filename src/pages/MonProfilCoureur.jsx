      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <p className="text-sm mb-2">
            Conformément à la réglementation FFA, vous pouvez choisir que votre nom apparaisse ou pas dans les résultats.
          </p>
          <label className="mr-4">
            <input
              ...
              value="true"
              checked={profil.apparaitre_resultats === true}
              onChange={() => setProfil({ ...profil, apparaitre_resultats: true })}
            /> Oui
          </label>
          <label>
            <input
              ...
              name="apparaitre_resultats"
              value="false"
              checked={profil.apparaitre_resultats === false}
              onChange={() => setProfil({ ...profil, apparaitre_resultats: false })}
            /> Non
          </label>
        </div>
        ...
        <div>
          ...
          <p className="text-sm mb-2">
            Pour participer à une compétition FFA, vous devez fournir une licence valide ou un PPS.
          </p>
          <label className="block mb-1">
            <input
              ...
              onChange={handleChange}
            /> Licence FFA (Compétition, Entreprise, Running)
          </label>
